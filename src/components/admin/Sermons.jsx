...
import ReactPlayer from 'react-player'; // Lazy load for better performance
            ...
            <div className={styles.mediaGrid}>
              ...
              <div className={styles.videoPreviewSection}>
                ...
                <div className={styles.miniPlayer}>
                  {formData.video_url ? (
                    <ReactPlayer url={formData.video_url} width="100%" height="100%" light controls />
                  ) : (
  ...
  return (
    <div className={styles.sermonCard}>
      <div className={styles.cardImage}>
        {sermon.image_url ? (
          <img src={sermon.image_url} alt={sermon.title} loading="lazy" />
        ) : (
