...
const PrayerHighlight = () => {
    const [latestPrayers, setLatestPrayers] = useState([]);
                ...
                <div className={styles.editorialLayout}>
                    ...
                    >
                        ...
                        <p className={styles.description}>
                            ...
                            Your request is a sacred trust. Join us in standing in the gap 
                            for these recent needs.
                        </p>
                    ...
                    <div className={styles.feedColumn}>
                        {loading ? (
                            ...
                            latestPrayers.map((prayer, index) => (
                                <motion.div 
                                    key={prayer.id} 
                                ...
                                >
                                    ...
                                    <p className={styles.requestText}>
                                        "{prayer.request.substring(0, 180)}..."
                                    </p>
