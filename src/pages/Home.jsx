...
import SupportAndConnect from '../components/SupportAndConnect';

// Lazy-loaded components
const LatestSermon = React.lazy(() => import('../components/LatestSermon'));
const AcademyPromo = React.lazy(() => import('../components/AcademyPromo'));
    ...
    <SmoothScroll>
      <div className={styles.pageWrapper}>
        <Seo 
          ...
          description="Welcome to PEFA Kawangware 56 Church, a vibrant Christian community in the heart of Nairobi, Kenya. We are dedicated to transforming lives through the powerful teaching of the Word, heartfelt worship, and genuine fellowship. Join our Sunday services, connect with our various church departments, or explore our rich resources including sermons, Bible studies, and upcoming events. Whether you are seeking a new church home or are curious about the Christian faith, we invite you to experience the love and grace of God with us. A place to belong, a place to grow."
          url="/"
          type="website"
        />
        {/* Scroll Progress Bar */}
          ...
          <div className={styles.container}>
            ...
            >
              ...
              <div className={styles.visionContent}>
                <h2 className={styles.visionTitle}>Our Guiding Vision</h2>
                <p className={styles.visionText}>{vision}</p>
                <Link to="/about" className={styles.visionBtn}>
        ...
        <Suspense fallback={<LoadingFallback />}>
          ...
          <UpcomingEvents />
          <ChurchDepartmentsSection limit={6} />
